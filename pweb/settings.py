...
DATABASES = {
   'default': dj_database_url.parse('postgresql://neondb_owner:npg_HxmwBz3Dn9IW@ep-rough-truth-ahgj80ih-pooler.c-3.us-east-1.aws.neon.tech/neondb?sslmode=require')
